function [ summary ] = performReliabilityAnalysis2( eeg, outPath, analyticsOnly)
...
analyticsFolder = 'C:\Users\Neuro\Documents\MATLAB\processed\Oregon\artifactPresentAnalytics';
[folder, file, ext] = fileparts(outPath);
surfacePath = fullfile(analyticsFolder, sprintf('%sSurface.mat', file));
icaPath = fullfile(analyticsFolder, sprintf('%sIca.mat', file));
