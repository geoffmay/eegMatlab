...
%    ind = 1;
    ...
    for ind = 1:length(a.plot95Raw)        
        ...
        if(doPlot)
            ...
            plotInd = find(strcmp({a.summaries.label}, searchString));
            if(ind == plotInd)
                close all;
                figure;
                scatter(x, b);
...
norms = load('/Users/Geoff/Documents/MATLAB/processed/Oregon/avgValues/subjectNorms.mat');
syms x;
