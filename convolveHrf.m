function [boldResponse, boldTimes] = convolveHrf(brainActivity, sampleRate)
...
boldResponse = convolution(spmHrf, 1:length(spmHrf), brainActivity, 1:length(brainActivity));
